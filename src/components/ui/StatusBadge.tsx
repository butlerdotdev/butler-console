...
export function StatusBadge({ status, className }: StatusBadgeProps) {
	...
	const statusConfig: Record<string, { bg: string; text: string; pulse?: boolean }> = {
		...
		installed: { bg: 'bg-green-500/10', text: 'text-green-400' },
		...
		upgrading: { bg: 'bg-blue-500/10', text: 'text-blue-400', pulse: true },
		degraded: { bg: 'bg-orange-500/10', text: 'text-orange-400' },
